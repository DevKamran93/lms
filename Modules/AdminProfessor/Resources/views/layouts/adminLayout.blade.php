...
<link rel="stylesheet" href="{{ asset('dashboard/assets/plugins/fullcalendar/fullcalendar.min.css') }}">
<link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-beta.1/dist/css/select2.min.css" rel="stylesheet" />
{{-- <link rel="stylesheet" href="../assets/plugins/nestable/jquery-nestable.css"/> --}}
<link rel="stylesheet" href="{{ asset('dashboard/assets/plugins/nestable/jquery-nestable.css') }}">
<!-- Plugins css -->
{{-- <link rel="stylesheet" href="../assets/plugins/summernote/dist/summernote.css"/> --}}
<link rel="stylesheet" href="{{ asset('dashboard/assets/plugins/summernote/dist/summernote.css') }}">
{{-- <link rel="stylesheet" href="../assets/plugins/summernote/dist/summernote.css"/> --}}
<link rel="stylesheet" href="asset('dashboard/assets/plugins/summernote/dist/summernote.css')">
...
<link rel="stylesheet" href="{{ asset('dashboard/assets/plugins/bootstrap-datepicker/css/bootstrap-datepicker3.min.css') }}">
<!-- Core css -->
{{-- <link rel="stylesheet" href="../assets/css/style.min.css"/> --}}
<link rel="stylesheet" href="{{ asset('dashboard/assets/css/style.min.css') }}">
<link rel="stylesheet" href="{{ asset('styles/speakersProfile.css') }}">
...
<style>
    ...
    .custom-checkbox .custom-control-input:checked ~ .card {
        border-color: #007bff;
    }
</style>
</head>
    ...
    <div id="header_top" class="header_top">
        <div class="container">
            ...
            <div class="hright">
                ...
                @csrf
                <button class="btn btn-default nav-link icon settingbar"><i class="fe fe-power"></i></button>
                </form>
            </div>
        </div>
    </div>
                    ...
                    <li>
                        ...
                        <div class="desc">
                            ...
                            <ul class="list-unstyled team-info margin-0 p-t-5">
                                <li><img src="{{ asset('dashboard/assets/images/xs/avatar1.jpg') }}" alt="Avatar"></li>
                                <li><img src="{{ asset('dashboard/assets/images/xs/avatar2.jpg') }}" alt="Avatar"></li>
                                <li><img src="{{ asset('dashboard/assets/images/xs/avatar3.jpg') }}" alt="Avatar"></li>
                                <li><img src="{{ asset('dashboard/assets/images/xs/avatar4.jpg') }}" alt="Avatar"></li>
                            </ul>
                        </div>
                    </li>
                    <li>
            ...
            <div class="tab-pane fade" id="righttab-Students" role="tabpanel">
                <div id="users">
                    ...
                    <ul class="right_chat list-unstyled list">
                        ...
                        <li>
                            <a href="javascript:void(0);" class="media">
                                <img class="media-object" src="{{ asset('dashboard/assets/images/xs/avatar6.jpg') }}" alt="">
                                <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);" class="media">
                                <img class="media-object" src="{{ asset('dashboard/assets/images/xs/avatar7.jpg') }}" alt="">
                                <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);" class="media">
                                <img class="media-object" src="{{ asset('dashboard/assets/images/xs/avatar8.jpg') }}" alt="">
                                <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);" class="media">
                                <img class="media-object" src="{{ asset('dashboard/assets/images/xs/avatar9.jpg') }}" alt="">
                                <div class="media-body">
                    ...
                    <div class="chat_windows">
                        <ul class="mb-0">
                            <li class="other-message">
                                <img class="avatar mr-3" src="{{ asset('dashboard/assets/images/xs/avatar1.jpg') }}" alt="avatar">
                                <div class="message">
                            ...
                            <li class="other-message">
                                ...
                                <div class="message">
                                    <div class="media_img">
                                        <img src="{{ asset('dashboard/assets/images/gallery/1.jpg') }}" class="w100 img-thumbnail" alt="">
                                        <img src="{{ asset('dashboard/assets/images/gallery/2.jpg') }}" class="w100 img-thumbnail" alt="">
                                    </div>
                                    <span class="time">10:15 AM, Today</span>
                                </div>
                            </li>
            ...
            <div class="tab-pane fade show active" id="menu-uni" role="tabpanel">
                <nav class="sidebar-nav">
                    <ul class="metismenu">
                        ...
                        <li><a href="#"><i class="fa fa-black-tie"></i><span>Admins</span></a></li>
                        ...
                        <li><a href="#"><i class="fa fa-graduation-cap"></i><span>Courses</span></a></li>
                        <li><a href="#"><i class="fa fa-graduation-cap"></i><span>Events</span></a></li>
                        <li><a href="#"><i class="fa fa-graduation-cap"></i><span>Event Speakers</span></a></li>
                        ...
                        <li><a href="#"><i class="fa fa-comments-o"></i><span>Chat App</span></a></li>
                        <li><a href="#"><i class="fa fa-comments-o"></i><span>Blogs</span></a></li>
                        <li><a href="#"><i class="fa fa-comments-o"></i><span>Categories</span></a></li>
                        <li><a href="#"><i class="fa fa-address-book"></i><span>Contact</span></a></li>
                        <li><a href="#"><i class="fa fa-folder"></i><span>FileManager</span></a></li>
            ...
            <div class="tab-pane fade" id="menu-admin" role="tabpanel">
                <nav class="sidebar-nav">
                    <ul class="metismenu">
                        ...
                        <li><a href="#"><i class="fa fa-dashboard"></i><span>Noticeboard</span></a></li>
                        <li><a href="#"><i class="fa fa-list-ul"></i><span>Taskboard</span></a></li>
                        <li><a href="#"><i class="fa fa-bed"></i><span>Hostel</span></a></li>
                        <li><a href="#"><i class="fa fa-truck"></i><span>Transport</span></a></li>
                        <li><a href="#"><i class="fa fa-calendar-check-o"></i><span>Attendance</span></a></li>
                        <li><a href="#"><i class="fa fa-flag"></i><span>Leave</span></a></li>
                    ...
                    <div class="right">
                        ...
                        <div class="notification d-flex">
                            <div class="dropdown d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <a class="dropdown-item" href="#"><img class="w20 mr-2" src="{{ asset('dashboard/assets/images/flags/us.svg') }}" alt="">English</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="#"><img class="w20 mr-2" src="{{ asset('dashboard/assets/images/flags/es.svg') }}" alt="">Spanish</a>
                                    <a class="dropdown-item" href="#"><img class="w20 mr-2" src="{{ asset('dashboard/assets/images/flags/jp.svg') }}" alt="">japanese</a>
                                    <a class="dropdown-item" href="#"><img class="w20 mr-2" src="{{ asset('dashboard/assets/images/flags/bl.svg') }}" alt="">France</a>
                                </div>
                            </div>
                            <div class="dropdown d-flex">
                            ...
                            <div class="dropdown d-flex">
                                <a href="javascript:void(0)" class="chip ml-3" data-toggle="dropdown">
                                    <span class="avatar" style="background-image: url({{ auth()->guard('admin')->user()->imagePath }})"></span> {{ auth()->guard('admin')->user()->name }}</a>
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    ...
                                    <form action="{{ route('logout') }}" method="post">
                                        @csrf
                                        <button type = "submit" class="dropdown-item w-75"><i class="dropdown-icon fe fe-log-out"></i> Sign out</button>
                                    </form>
                                </div>
                            </div>
                        </div>
...
<script src="{{ asset('dashboard/assets/bundles/summernote.bundle.js') }}"></script>

{{-- <script src="../assets/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script> --}}
<script src="{{ asset('dashboard/assets/plugins/bootstrap-datepicker/bootstrap-datepicker.min.js') }}"></script>
...
{{-- <script src="../assets/plugins/dropify/js/dropify.min.js"></script> --}}
<script src="{{ asset('dashboard/assets/plugins/dropify/js/dropify.min.js') }}"></script>
<script src="{{ asset('dashboard/assets/plugins/dropify/js/dropify.js') }}"></script>
{{-- <script src="assets/js/form/dropify.js"></script> --}}
<script src="{{ asset('dashboard/university/assets/js/form/dropify.js') }}"></script>
{{-- <script src="assets/js/page/dialogs.js"></script> --}}
<script src="{{ asset('dashboard/university/assets/js/page/dialogs.js') }}"></script>
<!-- Start project main js  and page js -->
{{-- <script src="../assets/js/core.js"></script> --}}
<script src="{{ asset('dashboard/assets/js/core.js') }}"></script>
{{-- <script src="assets/js/page/index.js"></script> --}}
<script src="{{ asset('dashboard/university/assets/js/page/index.js') }}"></script>
{{-- <script src="assets/js/page/summernote.js"></script> --}}
<script src="{{ asset('dashboard/university/assets/js/page/summernote.js') }}"></script>
{{-- <script src="assets/js/page/calendar.js"></script> --}}
<script src="{{ asset('dashboard/university/assets/js/page/calendar.js') }}"></script>
{{-- <script src="../assets/bundles/fullcalendar.bundle.js"></script> --}}
<script src="{{ asset('dashboard/assets/bundles/fullcalendar.bundle.js') }}"></script>
{{-- <script src="assets/js/page/sortable-nestable.js"></script> --}}
<script src="{{ asset('dashboard/university/assets/js/page/sortable-nestable.js') }}"></script>
{{-- <script src="assets/js/chart/knobjs.js"></script> --}}
<script src="{{ asset('dashboard/university/assets/js/chart/knobjs.js') }}"></script>
...
<script src="{{ asset('dashboard/assets/bundles/nestable.bundle.js') }}"></script>

<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-beta.1/dist/js/select2.min.js"></script>
<script src="{{ asset('scripts/getCities.js') }}"></script>
<script src="{{ asset('scripts/deleteCategory.js') }}"></script>
<script src="{{ asset('scripts/calculateTotalDays.js') }}"></script>
<script src="{{ asset('scripts/eventdays.js') }}"></script>
<script src="{{ asset('scripts/deleteSponsor.js') }}"></script>
<script src="{{ asset('scripts/blogLike.js') }}"></script>
<script src="{{ asset('scripts/followUnfollow.js') }}"></script>

{{-- <script src="{{ asset('scripts/sweatAlertDelete.js') }}"></script> --}}
