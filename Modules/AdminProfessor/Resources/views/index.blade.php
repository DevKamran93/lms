@extends('adminprofessor::layouts.adminLayout')
            ...
            <div class="col-6 col-md-4 col-xl-2">
                <div class="card">
                    <div class="card-body ribbon">
                        <div class="ribbon-box green" data-toggle="tooltip" title="New Professors">8</div>
                        {{-- <div class="ribbon-box green" data-toggle="tooltip" title="New Professors">{{ $professors }}</div> --}}
