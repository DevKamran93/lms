...
@section('content')
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xxl-7 col-xl-6">
                        <div class="banner-thumb">
                            <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/banner/01.png') }}" alt="img">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="sponsor-iten">
                                <div class="sponsor-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/sponsor/01.png') }}" alt="sponsor">
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="sponsor-iten">
                                <div class="sponsor-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/sponsor/02.png') }}" alt="sponsor">
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="sponsor-iten">
                                <div class="sponsor-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/sponsor/03.png') }}" alt="sponsor">
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="sponsor-iten">
                                <div class="sponsor-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/sponsor/04.png') }}" alt="sponsor">
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="sponsor-iten">
                                <div class="sponsor-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/sponsor/05.png') }}" alt="sponsor">
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="sponsor-iten">
                                <div class="sponsor-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/sponsor/06.png') }}" alt="sponsor">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-2 justify-content-center row-cols-xl-6 row-cols-md-3 row-cols-sm-2 row-cols-1">
                        ...
                        <div class="category-item text-center">
                            <div class="category-inner">
                                <div class="category-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/category/icon/01.jpg') }}" alt="category">
                                </div>
                    ...
                    <div class="col">
                        <div class="category-item text-center">
                            <div class="category-inner">
                                <div class="category-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/category/icon/02.jpg') }}" alt="category">
                                </div>
                                <div class="category-content">
                    ...
                    <div class="col">
                        <div class="category-item text-center">
                            <div class="category-inner">
                                <div class="category-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/category/icon/03.jpg') }}" alt="category">
                                </div>
                                <div class="category-content">
                    ...
                    <div class="col">
                        <div class="category-item text-center">
                            <div class="category-inner">
                                <div class="category-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/category/icon/04.jpg') }}" alt="category">
                                </div>
                                <div class="category-content">
                    ...
                    <div class="col">
                        <div class="category-item text-center">
                            <div class="category-inner">
                                <div class="category-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/category/icon/05.jpg') }}" alt="category">
                                </div>
                                <div class="category-content">
                    ...
                    <div class="col">
                        <div class="category-item text-center">
                            <div class="category-inner">
                                <div class="category-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/category/icon/06.jpg') }}" alt="category">
                                </div>
                                <div class="category-content">
                ...
                <div class="row g-4 justify-content-center row-cols-xl-3 row-cols-md-2 row-cols-1">
                        ...
                        <div class="course-item">
                            <div class="course-inner">
                                <div class="course-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/course/01.jpg') }}" alt="course">
                                </div>
                                <div class="course-content">
                                    ...
                                    <div class="course-footer">
                                        <div class="course-author">
                                            <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/course/author/01.jpg') }}" alt="course author">
                    ...
                    <div class="col">
                        <div class="course-item">
                            <div class="course-inner">
                                <div class="course-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/course/02.jpg') }}" alt="course">
                                </div>
                                <div class="course-content">
                                    <div class="course-price">$30</div>
                                    <div class="course-category">
                                    ...
                                    <div class="course-footer">
                                        <div class="course-author">
                                            <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/course/author/02.jpg') }}" alt="course author">
                    ...
                    <div class="col">
                        <div class="course-item">
                            <div class="course-inner">
                                <div class="course-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/course/03.jpg') }}" alt="course">
                                </div>
                                <div class="course-content">
                                    <div class="course-price">$30</div>
                                    <div class="course-category">
                                    ...
                                    <div class="course-footer">
                                        <div class="course-author">
                                            <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/course/author/03.jpg') }}" alt="course author">
                    ...
                    <div class="col">
                        <div class="course-item">
                            <div class="course-inner">
                                <div class="course-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/course/04.jpg') }}" alt="course">
                                </div>
                                <div class="course-content">
                                    <div class="course-price">$30</div>
                                    <div class="course-category">
                                    ...
                                    <div class="course-footer">
                                        <div class="course-author">
                                            <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/course/author/04.jpg') }}" alt="course author">
                    ...
                    <div class="col">
                        <div class="course-item">
                            <div class="course-inner">
                                <div class="course-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/course/05.jpg') }}" alt="course">
                                </div>
                                <div class="course-content">
                                    <div class="course-price">$30</div>
                                    <div class="course-category">
                                    ...
                                    <div class="course-footer">
                                        <div class="course-author">
                                            <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/course/author/05.jpg') }}" alt="course author">
                    ...
                    <div class="col">
                        <div class="course-item">
                            <div class="course-inner">
                                <div class="course-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/course/06.jpg') }}" alt="course">
                                </div>
                                <div class="course-content">
                                    <div class="course-price">$30</div>
                                    <div class="course-category">
                                    ...
                                    <div class="course-footer">
                                        <div class="course-author">
                                            <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/course/author/06.jpg') }}" alt="course author">
                    ...
                    <div class="about-right padding-tb">
                        ...
                        <div class="section-wrapper">
                            <ul class="lab-ul">
                                <li>
                                    <div class="sr-left">
                                        <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/about/icon/01.jpg') }}" alt="about icon">
                                    </div>
                                    <div class="sr-right">
                                ...
                                <li>
                                    <div class="sr-left">
                                        <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/about/icon/02.jpg') }}" alt="about icon">
                                    </div>
                                    <div class="sr-right">
                                ...
                                <li>
                                    <div class="sr-left">
                                        <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/about/icon/03.jpg') }}" alt="about icon">
                                    </div>
                                    <div class="sr-right">
                ...
                <div class="col">
                    <div class="about-left">
                        <div class="about-thumb">
                            <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/about/01.png') }}" alt="about">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4 justify-content-center row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xl-4">
                        ...
                        <div class="instructor-item">
                            <div class="instructor-inner">
                                <div class="instructor-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/instructor/01.jpg') }}" alt="instructor">
                                </div>
                                <div class="instructor-content">
                                    <a href="team-single.html"><h4>{{ $professor->name }}</h4></a>
                    ...
                    <div class="col">
                        <div class="instructor-item">
                            <div class="instructor-inner">
                                <div class="instructor-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/instructor/02.jpg') }}" alt="instructor">
                                </div>
                                <div class="instructor-content">
                    ...
                    <div class="col">
                        <div class="instructor-item">
                            <div class="instructor-inner">
                                <div class="instructor-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/instructor/03.jpg') }}" alt="instructor">
                                </div>
                                <div class="instructor-content">
                    ...
                    <div class="col">
                        <div class="instructor-item">
                            <div class="instructor-inner">
                                <div class="instructor-thumb">
                                    <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/instructor/04.jpg') }}" alt="instructor">
                                </div>
                                <div class="instructor-content">
    ...
    <!-- Instructors Section Ending Here -->
        ...
        <div class="course-section padding-tb section-bg">
            <div class="container">
                <div class="section-header text-center">
                    <span class="subtitle">Featured Events</span>
                    <h2 class="title">Events by LMS</h2>
                </div>
                <div class="section-wrapper">
                    <div class="row g-4 justify-content-center row-cols-xl-3 row-cols-md-2 row-cols-1">
                            ...
                            <div class="course-item">
                                <div class="course-inner">
                                    ...
                                    <div class="course-content">
                                        ...
                                        <a href="course-single.html"><h5>{{ $event->title }}</h5></a>
                                        <div class="course-details">
                                            <div class="couse-count"><i class="icofont-video-alt"></i> 18x Lesson</div>
                                            <div class="couse-topic"><i class="icofont-signal"></i> Online Class</div>
                                        </div>
                                        <div class="course-footer">
                                            <div class="course-author">
                                                <img src="{{ Storage::url($event->linkable->imagePath) }}" alt="course author"  style="width: 50px; border-radius:50%">
                                                <a href="team-single.html" class="ca-name">{{ $event->linkable->name }}</a>
                                            </div>
                                            <div class="course-btn">
                                                <a href="course-single.html" class="lab-btn-text">Read More <i class="icofont-external-link"></i></a>
                                            </div>
            ...
            <div class="section-wrapper">
                <div class="row justify-content-center row-cols-lg-2 row-cols-1">
                    <div class="col">
                        <div class="sf-left">
                            <div class="sfl-thumb">
                                <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/feedback/01.jpg') }}" alt="student feedback">
                                ...
                                <div class="stu-feed-top">
                                    <div class="sft-left">
                                        <div class="sftl-thumb">
                                            <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/feedback/student/01.jpg') }}" alt="student feedback">
                                        </div>
                        ...
                        <div class="stu-feed-item">
                            <div class="stu-feed-inner">
                                <div class="stu-feed-top">
                                    <div class="sft-left">
                                        <div class="sftl-thumb">
                                            <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/feedback/student/02.jpg') }}" alt="student feedback">
                                        </div>
                                        <div class="sftl-content">
        ...
        <div class="container">
            ...
            <div class="section-wrapper">
                <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 justify-content-center g-4">
                        ...
                        <div class="post-item">
                            <div class="post-inner">
                                <div class="post-thumb">
                                    <a href="{{ route('singleBlog',$blog->id) }}"><img src="assets/images/blog/01.jpg" alt="blog thumb"></a>
                                </div>
                                <div class="post-content">
                                    <a href="{{ route('singleBlog',$blog->id) }}"><h4>{{ $blog->title }}</h4></a>
                                    <div class="meta-post">
                                        <ul class="lab-ul">
                                            <li><i class="icofont-ui-user"></i>{{ $blog->linkable->name }}</li>
                                ...
                                <div class="post-footer">
                                    ...
                                    <div class="pf-right">
                                        ...
                                        <span class="comment-count">{{ $blog->blogComments->count() }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    @endforeach --}}
                    <div class="text-center mt-5">
                        <a href="" class="lab-btn"><span>Browse All Blog Posts</span></a>

                        {{-- <a href="{{ route('blogs') }}" class="lab-btn"><span>Browse All Blog Posts</span></a> --}}
                    </div>
                    <div class="col">
                        <div class="post-item">
                            <div class="post-inner">
                    ...
                    <div class="row g-4 row-cols-1 row-cols-lg-2">
                            ...
                            <div class="achieve-item">
                                <div class="achieve-inner">
                                    <div class="achieve-thumb">
                                        <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/achive/01.png') }}" alt="achieve thumb">
                                    </div>
                        ...
                        <div class="col">
                            <div class="achieve-item">
                                <div class="achieve-inner">
                                    <div class="achieve-thumb">
                                        <img src="{{ asset('landing pages/LMS/Edukon Main HTML Template/buyer-file/edukon/assets/images/achive/02.png') }}" alt="achieve thumb">
                                    </div>
                                    <div class="achieve-content">
